...
def load_data(*args, **kwargs):
    ...
    # Refrescar el token antes de la llamada
    ...
    query = f"select * from Invoice{where_clause} order by Metadata.LastUpdatedTime asc"
    ...
    if not data:
        data = [{"Id": "test", "DocNumber": "000", "TxnDate": "2025-01-01"}]
...
def transform(data, *args, **kwargs):
    ...
    for i, record in enumerate(data):
        ...
        registros.append(registro)  # 👈 ahora sí está dentro del for
...
def test_output(*outputs) -> None:
    """
    Prueba simple para asegurar que hay salida.
    """
