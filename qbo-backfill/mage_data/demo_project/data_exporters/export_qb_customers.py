...
@data_exporter
def export_customers(data, *args, **kwargs):
    """
    Inserta registros en la tabla raw.qb_customers en Postgres con UPSERT.
    Crea el esquema y la tabla si no existen.
    """

    print("Conectando a Postgres para customers...")
    ...
    print(f"Registros recibidos en export_customers: {len(rows)}")
    ...
    print(f"Exportación terminada: {insertados} registros insertados/actualizados en raw.qb_customers")
